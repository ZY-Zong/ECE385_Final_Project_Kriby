...
module final_nios_system_mm_interconnect_0_router_default_decode
  #(
...
module final_nios_system_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    final_nios_system_mm_interconnect_0_router_default_decode the_default_decode(
